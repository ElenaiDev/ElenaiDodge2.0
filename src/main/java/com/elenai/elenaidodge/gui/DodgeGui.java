...
public class DodgeGui {
	...
	public void onRenderDodgeGUIEvent(RenderGameOverlayEvent.Post event) {
		if (event.getType() == ElementType.FOOD && ModConfig.client.hud.hud) {
			...
			renderFeathers(event.getResolution().getScaledHeight(),
					...
					ClientStorage.healing, 16, 25, 34, 43, 52, 61, 70, PatronRewardHandler.getTier(Minecraft.getMinecraft().player));
