...
public class ModConfig {
	...
	public static class Common {
		...
		public class Balance {
			...
			public int invincibilityTicks = 16;
		...
		public class Weights {
			...
			@Name("Armor Weights")
			@Comment("The weight of each item of Armor. Each 'Steel Feather' is equivalent to a weight of 2. Insert values as such: modid:itemname=value. Any item with a weight over 24 will not show its weight as a tooltip. Idea Credit: SandwichHorror")
