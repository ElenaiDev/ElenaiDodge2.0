...
public final class ConfigHandler {
	...
	public static class Common {
		...
		public Common(ForgeConfigSpec.Builder builder) {
			...
			invincibilityTicks = builder
					...
					.defineInRange("balance.invincibility_ticks", 16, 0, 100);
			potions = builder
			...
			// WEIGHTS
			weights = builder
					.comment("The weight of each item of Armor. Each 'Steel Feather' is equivalent to a weight of 2. Insert values as such: modid:itemname=value,modid:itemname=value. Any item with a weight over 24 will not show its weight as a tooltip. Idea Credit: SandwichHorror")
	...
	// Common
	public static double force, verticality, exhaustion;
